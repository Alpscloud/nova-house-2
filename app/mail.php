...
$admin_email = array('orders@anovahouse.com.ua, winde100kg@gmail.com'); // первым поставь почту, на которую будет указывать ответ и т.п.
...
'From: '.adopt($project_name).' <no-reply@anovahouse2.com.ua>' . PHP_EOL .  // Вот тут как раз мы и используем первый адрес
